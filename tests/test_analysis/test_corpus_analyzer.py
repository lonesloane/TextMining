...
class CorpusAnalyzerTestCase(unittest.TestCase):
    ...
    def test_process_enrichment_result(self):
        ...
        self.assertEqual(self.analyzer.topics_hash["45"], ('lbl_en_45', 'lbl_fr_45'))
        self.assertEqual(self.analyzer.files_hash['JT03.xml'], [('30', 'N'), ('24', 'N'), ('42', 'N'), ('3', 'N'),
                                                                ('35', 'N'), ('5', 'H'), ('18', 'N'), ('31', 'N'),
                                                                ('14', 'N'), ('45', 'N'), ('9', 'H'), ('46', 'N'),
                                                                ('38', 'N'), ('6', 'N'), ('7', 'N')])
        result_file = "JT06.xml"
        self.analyzer._process_enrichment_result(folder=TEST_CORPUS_ROOT_FOLDER, result_file=result_file)
        self.assertEqual(self.analyzer.topics_occurrences_hash["45"], [('JT03.xml', 'N'), ('JT06.xml', 'N')])
        self.assertEqual(self.analyzer.topics_hash["45"], ('lbl_en_45', 'lbl_fr_45'))
        self.assertEqual(self.analyzer.files_hash['JT03.xml'], [('30', 'N'), ('24', 'N'), ('42', 'N'), ('3', 'N'),
                                                                ('35', 'N'), ('5', 'H'), ('18', 'N'), ('31', 'N'),
                                                                ('14', 'N'), ('45', 'N'), ('9', 'H'), ('46', 'N'),
    ...
    def test_remove_file_from_files_hash(self):
        self.analyzer.files_hash['JT01.xml'] = [('1', 'N'), ('2', 'H')]
        self.analyzer.files_hash['JT02.xml'] = [('3', 'N'), ('4', 'H')]
        self.analyzer.files_hash['JT03.xml'] = [('5', 'N'), ('6', 'H')]

        self.assertEqual(3, len(self.analyzer.files_hash))
        self.assertTrue(self.analyzer.files_hash.has_key('JT01.xml'))
        self.assertTrue(self.analyzer.files_hash.has_key('JT02.xml'))
        self.assertTrue(self.analyzer.files_hash.has_key('JT03.xml'))
        self.analyzer._remove_file_from_files_hash('JT01.xml')
        self.assertEqual(2, len(self.analyzer.files_hash))
        self.assertFalse(self.analyzer.files_hash.has_key('JT01.xml'))
        self.assertTrue(self.analyzer.files_hash.has_key('JT02.xml'))
        self.assertTrue(self.analyzer.files_hash.has_key('JT03.xml'))
    ...
    def test_remove_file_from_topics_occurrences_hash(self):
        ...
        self.assertEqual(4, len(self.analyzer.topics_occurrences_hash))
        self.assertEqual([('JT01.xml', 'N'), ('JT03.xml', 'H')], self.analyzer.topics_occurrences_hash['1'])
        self.assertEqual([('JT01.xml', 'H'), ('JT03.xml', 'N')], self.analyzer.topics_occurrences_hash['2'])
        self.assertEqual([('JT02.xml', 'N'), ('JT04.xml', 'H')], self.analyzer.topics_occurrences_hash['3'])
        self.assertEqual([('JT02.xml', 'H'), ('JT04.xml', 'N')], self.analyzer.topics_occurrences_hash['4'])
        self.analyzer._remove_file_from_topics_occurrences_hash('JT01.xml')
        self.assertEqual(4, len(self.analyzer.topics_occurrences_hash))
        self.assertEqual([('JT03.xml', 'H')], self.analyzer.topics_occurrences_hash['1'])
        self.assertEqual([('JT03.xml', 'N')], self.analyzer.topics_occurrences_hash['2'])
        self.assertEqual([('JT02.xml', 'N'), ('JT04.xml', 'H')], self.analyzer.topics_occurrences_hash['3'])
        self.assertEqual([('JT02.xml', 'H'), ('JT04.xml', 'N')], self.analyzer.topics_occurrences_hash['4'])
    ...
    def test_dismiss_duplicates(self):
        ...
        self.assertEqual(self.analyzer.topics_occurrences_hash["45"], [("JT06.xml", "N"), ("JT03.xml", "N")])
        self.assertEqual(self.analyzer.topics_hash["45"], ('lbl_en_45', 'lbl_fr_45'))
        self.assertEqual(self.analyzer.files_hash['JT03.xml'], [('30', 'N'), ('24', 'N'), ('42', 'N'), ('3', 'N'),
                                                                ('35', 'N'), ('5', 'H'), ('18', 'N'), ('31', 'N'),
                                                                ('14', 'N'), ('45', 'N'), ('9', 'H'), ('46', 'N'),
    ...
    def test_debug_duplicates(self):
        ...
        self.analyzer.files_hash['JT00104374.xml'] = [('1', 'N')]
        self.analyzer.topics_occurrences_hash["1"] = topic_occurrences
        self.assertTrue(('JT00104374.xml', 'N') in self.analyzer.topics_occurrences_hash["1"])
        self.analyzer._remove_file_from_topics_occurrences_hash('JT00104374.xml')
        self.assertFalse(('JT00104374.xml', 'N') in self.analyzer.topics_occurrences_hash["1"])
    ...
    def test_process_file_topics(self):
        ...
        expected = [('1', 'N')]
        actual = self.analyzer.files_hash[result_file]
